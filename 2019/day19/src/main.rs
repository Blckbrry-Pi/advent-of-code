...
const PART_1: &str = include_str!("../../../data/2019/day19/p1.txt");
const PART_2: &str = include_str!("../../../data/2019/day19/p2.txt");

fn part1() {
    let start = Instant::now();
    let template_data = parse_input(PART_1);
...
fn part2() {
    let start = Instant::now();
    let template_data = parse_input(PART_2);
